...
export const SignInAsRider = ({auth,setAuth}) => {
  ...
  function handleSubmit(e){
    ...
    axios.post(`/api/users/registerAsRider/`,body)
        .then((response)=>{
...
<div class="relative z-0 w-full mb-5 group">
  ...
  <div class="relative z-0 w-full mb-5 group">
      <input type="text" name="number" id="number" class="block py-3 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-gray-600 peer" placeholder=" " required />
